...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'allegro-test':
				frames = Paths.getSparrowAtlas('allegrotest','shared',true);
				animation.addByPrefix('idle', 'AL idle', 24, false);
				animation.addByPrefix('singUP', 'AL up', 24, false);
				animation.addByPrefix('singDOWN', 'AL down', 24, false);
				animation.addByPrefix('singLEFT', 'AL left', 24, false);
				animation.addByPrefix('singRIGHT', 'AL right', 24, false);
			...
			case 'allegro-1':
				frames = Paths.getSparrowAtlas('allegro1','shared',true);
				animation.addByPrefix('idle', 'AL idle', 24, false);
				animation.addByPrefix('singUP', 'AL up', 24, false);
				animation.addByPrefix('singDOWN', 'AL down', 24, false);
				animation.addByPrefix('singLEFT', 'AL left', 24, false);
			...
			case 'allegro-2':
				frames = Paths.getSparrowAtlas('allegro2','shared',true);
				animation.addByPrefix('idle', 'AL idle', 24, false);
				animation.addByPrefix('singUP', 'AL up', 24, false);
				animation.addByPrefix('singDOWN', 'AL down', 24, false);
				animation.addByPrefix('singLEFT', 'AL left', 24, false);
			...
			case 'allegro-3':
				frames = Paths.getSparrowAtlas('allegro3','shared',true);
				animation.addByPrefix('idle', 'AL idle', 24, false);
				animation.addByPrefix('singUP', 'AL up', 24, false);
				animation.addByPrefix('singDOWN', 'AL down', 24, false);
				animation.addByPrefix('singLEFT', 'AL left', 24, false);
			...
			case 'bfm1':
				frames = Paths.getSparrowAtlas('bfm1','shared',true);
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT0', 24, false);
			...
			case 'bfm2':
				frames = Paths.getSparrowAtlas('bfm2','shared',true);
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT0', 24, false);
			...
			case 'bfm3':
				frames = Paths.getSparrowAtlas('bfm3','shared',true);
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
				animation.addByPrefix('singRIGHT', 'BF NOTE RIGHT0', 24, false);
			...
			case 'bfm1dead':
				frames = Paths.getSparrowAtlas('bfm1DEAD','shared',true);
				animation.addByPrefix('firstDeath', "BF dies", 24, false);
			...
			case 'bfm2dead':
				frames = Paths.getSparrowAtlas('bfm2DEAD','shared',true);
				animation.addByPrefix('firstDeath', "BF dies", 24, false);
				animation.addByPrefix('deathLoop', "BF Dead Loop", 24, true);
				animation.addByPrefix('deathConfirm', "BF Dead confirm", 24, false);
				animation.play('firstDeath');
			...
			case 'bfm3dead':
				frames = Paths.getSparrowAtlas('bfm3DEAD','shared',true);
				animation.addByPrefix('firstDeath', "BF dies", 24, false);
				animation.addByPrefix('deathLoop', "BF Dead Loop", 24, true);
				animation.addByPrefix('deathConfirm', "BF Dead confirm", 24, false);
				animation.play('firstDeath');
