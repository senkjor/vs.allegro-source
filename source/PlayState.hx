...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'allegro':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/allegro/allegroDialogue'));
			case 'moderato':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/moderato/moderatoDialogue'));
			case 'finale':
				dialogue = CoolUtil.coolTextFile(Paths.txt('data/finale/finaleDialogue'));		
		}
				...
				case 'fg1':
					{
						defaultCamZoom = 0.75;
						curStage = 'fg1';
						var bg:FlxSprite = new FlxSprite (-377,-309).loadGraphic(Paths.image('beatCity-1', 'allegro'));
				...
				case 'fg2':
					{
						defaultCamZoom = 0.75;
						curStage = 'fg1';
						var bg:FlxSprite = new FlxSprite (-377,-309).loadGraphic(Paths.image('beatCity-2', 'allegro'));
						bg.antialiasing = false;
						bg.scrollFactor.set(1, 1);
						bg.active = false;
						add(bg);
				...
				case 'fg3':
					{
						defaultCamZoom = 0.75;
						curStage = 'fg1';
						var bg:FlxSprite = new FlxSprite (-377,-309).loadGraphic(Paths.image('beatCity-3', 'allegro'));
						bg.antialiasing = false;
						bg.scrollFactor.set(1, 1);
						bg.active = false;
						add(bg);
		...
		else
		{
			if (isStoryMode)
			{
				...
				else
				{
					...
					if(StringTools.replace(PlayState.storyPlaylist[0], " ", "-").toLowerCase() == 'finale')
						{
							FlxG.switchState(new VideoState('assets/videos/funny.webm', new PlayState()));
						}
					else
						{
